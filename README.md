# Remote Savant Mcp TypeScript API Library
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/remote-savant-mcp-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/remote-savant-mcp-typescript/issues) with questions, bugs, or suggestions.
