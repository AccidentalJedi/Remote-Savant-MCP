import fs from 'fs';
import type { ResponseLike } from 'remote-savant-mcp/internal/to-file';
import { toFile } from 'remote-savant-mcp/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('remote-savant-mcp/core/uploads');
    await expect(
